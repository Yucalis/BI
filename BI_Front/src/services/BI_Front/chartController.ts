...
/** genChartAsync POST /api/chart/genAsync */
export async function genChartAsyncUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartAsyncUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
export async function listChartByPageUsingPOST(
  ...
  return request<API.BaseResponsePageChart_>('/api/chart/list/chart', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyChartByPageUsingPOST(
  ...
  return request<API.BaseResponsePageChart_>('/api/chart/my/list/chart', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
